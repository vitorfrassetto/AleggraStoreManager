...
if (isset($_POST['confirmar'])) {
    ...
    $tabelas = array("param_cores", "param_modelos", "param_produtos", "param_tecidos", "vendas", "produtos");
    ...
    foreach ($tabelas as $tabela) {
        ...
        // Redefinir o auto incremento para 1
    ...
    echo "<script language='javascript' type='text/javascript'>
        alert('Todos os dados das tabelas foram excluídos com sucesso!');
        window.location.href='../../../parametros/dados.php';
        </script>";
}
?>
...
<body class="corpo">
    ...
    <p>Tem certeza de que deseja excluir todos os dados das tabelas?</p>
    <form method="post">
